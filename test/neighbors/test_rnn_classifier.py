...
from src.ML.neighbors import RNNClassifier
...
rnnc = RNNClassifier(radius=1.0, weights='distance')
rnnc.fit(X_train_scaled, y_train)

y_pred = rnnc.predict(X_test_scaled)
accuracy = rnnc.score(y_pred, y_test)
